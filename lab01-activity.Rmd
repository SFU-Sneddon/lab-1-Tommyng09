...
head -n 25 /local-scratch/course_files/MBB243/Sneddon_genotypes.txt >> ~/MBB243/genotype_head.txt #just append the file
head -n 25 /local-scratch/course_files/MBB243/Sneddon_genotypes.txt > ~/MBB243/genotype_head.txt #just ovverwrite the file 
#head -n 25 /local-scratch/course_files/MBB243/Sneddon_genotypes.txt >> ~/MBB243/out/genotype_head.txt
#>> is to append the output to a file / create a file when the name does not exsit.
#error is shown because there is not such ~/MBB243/out/genotype_head.txt directories 
#mainly because there is no such file called "out"
...
#Some of the genotypes "look off" because they are repeated and filtered out by the "uniq" command
```
...
```{bash}
source /localhome/chihungn/.bashrc
DATA=/local-scratch/course_files/MBB243/
echo "" > ~/.bash_profile
cat ~/.bash_profile
wc -l ~/.bash_profile
...
library(reticulate)
#install_miniconda()
#reticulate::install_miniconda(force = TRUE) #overwrite
